...
public class A4E1 {
	 ...
	 */
	private static void setup(City c, int refStreet, int refAve, int length, int height, int numOfChairs) {
		...
		for (int i = 0; i < numOfChairs; i++) {
			...
			Thing thisThing = new Thing(c, chairStreet, chairAve);
		}
	}
	...
	public static void main(String[] args) {
		...
		setup(oakville, referenceStreet, referenceAve, length, height, numOfChairs);
		...
		CleaningRobot thisRobot = new CleaningRobot(oakville, roboX, roboY, directions[randomDirection]);
		thisRobot.cleanRoom();
	}
